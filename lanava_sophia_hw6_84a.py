...
theta_0 = 179 #angle at which pendulum was initially released, degrees
omega_0 = 0
...
def f(r,t):
    ...
    omega = r[1]
    ftheta = omega
    fomega = (-g/l)*sin(theta) #define the function
...
plt.title('Angle of Displacement of a Pendulum Over Time')
plt.xlabel('Time')
plt.ylabel('Angle')
plt.show()